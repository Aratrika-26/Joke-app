let arr=[`What did one hat say to the other? You stay here. I'll go on ahead.`,
...
`pomeranian dog on pool float dog wearing sunglasses, dog on vacation, floating in a swimming pool on a pizza shaped pool raft conceptual image for relaxation, labor day, memorial day, fourth of july, and summer funpinterest Jena Ardell`,
...
`senior woman and adult daughter laughing on porchpinterest MoMo Productions`,
...
`grandmother and grandson fooling around, using bananas as telephones, laughingpinterest Emely.`,
`What did the full glass say to the empty glass? You look drunk.`,
...
function jokes() {
    ...
    let x=document.getElementsByClassName("content")[0].innerHTML=arr[rand];
    let a=document.getElementsByClassName("content")[0].style.visibility="visible";
    console.dir(a)
}
